"""
Django settings for NewsPaper_ project.
...
SECRET_KEY = 'django-insecure-vh4pmgds=-0(n34%htr$=xk527-fm$6l1g6w^ry^vuj-#jt@+)'
...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['console_1', 'console_2', 'console_3', 'file_1', 'file_2'],
            'propagate': True,
            'level': 'DEBUG',
        },
        'django.request': {
